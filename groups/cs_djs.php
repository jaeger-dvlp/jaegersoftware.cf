...
$sorgu = $vt->prepare('SELECT * FROM js');
$sorgu->execute();
...
<head>
    ...
    <title>Discord.JS Kütüphanesi</title>
...
<body style="background-color: #1F2026;">
    ...
    <div class="d-flex mt-5 col-12">
        <div class="hitext mx-auto row text-center">Discord.JS<br>
            Kütüphanesi
        </div>
        ...
        foreach ($test as $data) { ?>
            <div class="group col-12 col-sm-10 col-lg-7 col-md-8 mx-auto mt-5 mb-5">
                <div class=" group-header w-100 text-center">
                    ...
                    <div class="gh2 mt-1 mx-auto text-center">Discord.JS</div>
